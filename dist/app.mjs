...
let workspace=loadWorkspace(),active=null,activeView='project',saveTimer,toastTimer,cloudTimer,session=null,logoObjectUrls=[],templates=[],pendingImport=null,pendingTemplate=null,csvTarget='';
...
async function showView(view){
  ...
  else{releaseLogoUrls();renderFormView();}renderReadiness();
}
