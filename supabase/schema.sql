...
begin
  ...
  if p_section_key='__project__' then
    ...
    v_lists:=array['references','uses','software','exchanges','compliance'];
    ...
    v_lists:=array['milestones','deliverables','clashes','meetings','qaChecks','assetRequirements','risks'];
  elsif p_section_key='organization' then
    v_lists:=array['parties','team','responsibilities','detailedResponsibilities','mobilization'];
